...
int main()
{
	...
	// note 4: Un tableau de char constant avec le caractère de terminaison porte le nom de c-string et était la façon de faire en C
	...
	// note 1: Il n'est pas possible d'afficher le tableau ainsi:  "cout << voyelles;"  car il n'y a pas de caractère de terminaison
