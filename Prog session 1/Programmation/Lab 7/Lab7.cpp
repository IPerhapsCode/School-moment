...
//Demande du mot de passe (simplifier le code trop de répétition)
...
//Demande du mot de passe précèdement enregistrer (Même chose répétition de code)fuck
mdpv = " ";
